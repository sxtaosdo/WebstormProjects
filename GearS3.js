...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{a1:0,a2:1,第1关开始位置:24,level1Complete:119,第2关开始位置:124,level2Complete:214,第3关开始位置:219,level3Complete:302,showIcon:112});
	...
	this.topIcon.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.topIcon).wait(8).to({alpha:1},0).to({_off:true},307).wait(4));
	...
	// 倒数开始👀
	this.instance_4 = new lib.倒数开始mc("synched",0,false);
	this.instance_4.parent = this;
	this.instance_4.setTransform(319.4,568.7);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(24).to({_off:false},0).to({_off:true},91).wait(9).to({_off:false},0).to({_off:true},91).wait(4).to({_off:false},0).to({_off:true},96).wait(4));

	// 第一关
	this.instance_5 = new lib.a2_第一关();
	this.instance_5.parent = this;
	this.instance_5.setTransform(319.6,925.3);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(8).to({_off:false},0).to({y:945.3,alpha:1},7,cjs.Ease.get(1)).wait(97).to({alpha:0},7,cjs.Ease.get(-1)).to({_off:true},1).wait(199));

	// 第二关
	this.instance_6 = new lib.a2_第二关();
	this.instance_6.parent = this;
	this.instance_6.setTransform(319.6,925.3);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(124).to({_off:false},0).to({y:945.3,alpha:1},7,cjs.Ease.get(1)).wait(76).to({alpha:0},7,cjs.Ease.get(-1)).to({_off:true},1).wait(104));

	// 第三关
	this.instance_7 = new lib.a2_第三关();
	this.instance_7.parent = this;
	this.instance_7.setTransform(319.6,925.3);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(219).to({_off:false},0).to({y:945.3,alpha:1},7,cjs.Ease.get(1)).wait(76).to({alpha:0},7,cjs.Ease.get(-1)).to({_off:true},1).wait(9));
	...
	// cp1_black
	this.instance_8 = new lib.cp1_black();
	this.instance_8.parent = this;
	this.instance_8.setTransform(318.9,567);
	this.instance_8.alpha = 0.801;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(109).to({alpha:1},5).wait(10).to({alpha:0.801},0).wait(80).to({alpha:1},5).wait(10).to({alpha:0.801},0).wait(80).to({alpha:1},5).to({_off:true},11).wait(4));

	// cp1
	this.instance_9 = new lib.cp1_1();
	this.instance_9.parent = this;
	this.instance_9.setTransform(318.9,558);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).to({_off:true},315).wait(4));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_13},{t:this.btnReplay},{t:this.instance_12},{t:this.instance_11},{t:this.instance_10},{t:this.failMc}]},315).to({state:[]},1).wait(3));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/a1_bt1.png?1482142236261", id:"a1_bt1"},
		{src:"images/a1_bt2.png?1482142236261", id:"a1_bt2"},
		{src:"images/a1_jiantou.png?1482142236261", id:"a1_jiantou"},
		{src:"images/a1_line.png?1482142236261", id:"a1_line"},
		{src:"images/a1_point.png?1482142236261", id:"a1_point"},
		{src:"images/a1_shou.png?1482142236261", id:"a1_shou"},
		{src:"images/a1_slg.png?1482142236261", id:"a1_slg"},
		{src:"images/a1_txt.png?1482142236261", id:"a1_txt"},
		{src:"images/a2_di1guan.png?1482142236261", id:"a2_di1guan"},
		{src:"images/a2_di2guan.png?1482142236261", id:"a2_di2guan"},
		{src:"images/a2_di3guan.png?1482142236261", id:"a2_di3guan"},
		{src:"images/bg_black.png?1482142236261", id:"bg_black"},
		{src:"images/cp1.png?1482142236261", id:"cp1"},
		{src:"images/cp2.png?1482142236261", id:"cp2"},
		{src:"images/logo.png?1482142236261", id:"logo"},
		{src:"images/您解开gears3密码用了.png?1482142236261", id:"您解开gears3密码用了"},
		{src:"images/挑战失败_.png?1482142236261", id:"挑战失败"},
		{src:"images/挑战套路深再来较次真_.png?1482142236261", id:"挑战套路深再来较次真"},
		{src:"images/组9拷贝21.png?1482142236261", id:"组9拷贝21"},
		{src:"images/组9拷贝2.png?1482142236261", id:"组9拷贝2"},
		{src:"images/组9拷贝.png?1482142236261", id:"组9拷贝"},
		{src:"images/组9.png?1482142236261", id:"组9"},
		{src:"images/表盘10.png?1482142236261", id:"表盘10"},
		{src:"images/表盘11.png?1482142236261", id:"表盘11"},
		{src:"images/表盘11bg.jpg?1482142236261", id:"表盘11bg"},
		{src:"images/表盘11txt2.png?1482142236261", id:"表盘11txt2"},
		{src:"images/表盘11大.png?1482142236261", id:"表盘11大"},
		{src:"images/表盘12.png?1482142236261", id:"表盘12"},
		{src:"images/表盘13.png?1482142236261", id:"表盘13"},
		{src:"images/表盘13bg.jpg?1482142236261", id:"表盘13bg"},
		{src:"images/表盘13txt2.png?1482142236261", id:"表盘13txt2"},
		{src:"images/表盘13大.png?1482142236261", id:"表盘13大"},
		{src:"images/表盘14.png?1482142236261", id:"表盘14"},
		{src:"images/表盘15.png?1482142236261", id:"表盘15"},
		{src:"images/表盘16.png?1482142236261", id:"表盘16"},
		{src:"images/表盘17.png?1482142236261", id:"表盘17"},
		{src:"images/表盘18.png?1482142236261", id:"表盘18"},
		{src:"images/表盘18bg.jpg?1482142236261", id:"表盘18bg"},
		{src:"images/表盘18txt2.png?1482142236261", id:"表盘18txt2"},
		{src:"images/表盘18大.png?1482142236261", id:"表盘18大"},
		{src:"images/表盘19.png?1482142236261", id:"表盘19"},
		{src:"images/表盘21.png?1482142236261", id:"表盘21"},
		{src:"images/表盘22.png?1482142236261", id:"表盘22"},
		{src:"images/表盘23.png?1482142236261", id:"表盘23"},
		{src:"images/表盘23bg.jpg?1482142236261", id:"表盘23bg"},
		{src:"images/表盘23txt2.png?1482142236261", id:"表盘23txt2"},
		{src:"images/表盘23大.png?1482142236261", id:"表盘23大"},
		{src:"images/表盘24.png?1482142236261", id:"表盘24"},
		{src:"images/表盘25.png?1482142236261", id:"表盘25"},
		{src:"images/表盘26.png?1482142236261", id:"表盘26"},
		{src:"images/表盘26bg.jpg?1482142236261", id:"表盘26bg"},
		{src:"images/表盘26txt2.png?1482142236261", id:"表盘26txt2"},
		{src:"images/表盘26大.png?1482142236261", id:"表盘26大"},
		{src:"images/表盘27.png?1482142236261", id:"表盘27"},
		{src:"images/表盘28.png?1482142236261", id:"表盘28"},
		{src:"images/表盘28bg.jpg?1482142236261", id:"表盘28bg"},
		{src:"images/表盘28txt2.png?1482142236261", id:"表盘28txt2"},
		{src:"images/表盘28大.png?1482142236261", id:"表盘28大"},
		{src:"images/表盘31.png?1482142236261", id:"表盘31"},
		{src:"images/表盘32.png?1482142236261", id:"表盘32"},
		{src:"images/表盘33.png?1482142236261", id:"表盘33"},
		{src:"images/表盘33bg.jpg?1482142236261", id:"表盘33bg"},
		{src:"images/表盘33txt2.png?1482142236261", id:"表盘33txt2"},
		{src:"images/表盘33大.png?1482142236261", id:"表盘33大"},
		{src:"images/表盘34.png?1482142236261", id:"表盘34"},
		{src:"images/表盘35.png?1482142236261", id:"表盘35"},
		{src:"images/过关了哎哟不错哦_.png?1482142236261", id:"过关了哎哟不错哦"}
	],
	preloads: []
};
