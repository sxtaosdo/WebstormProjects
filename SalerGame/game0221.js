...
}).prototype = getMCSymbolPrototype(lib.Symbol2, new cjs.Rectangle(0,0,93,127), null);
...
(lib.p4爆炸 = function(mode,startPosition,loop) {
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(73.8,9.4,0.4,0.4,90);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({scaleX:1,scaleY:1,rotation:-390,guide:{path:[73.8,9.4,85.7,-17.5,66.8,-42.6,35.4,-84.7,-7.6,-0.2]}},14).to({_off:true},2).wait(9));
...
(lib.page5 = function(mode,startPosition,loop) {
	...
	// 结算在玩一次
	this.instance = new lib.结算在玩一次();
	this.instance.parent = this;
	this.instance.setTransform(-8.4,374.4,0.165,0.165);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(20).to({_off:false},0).to({scaleX:1.15,scaleY:1.15},6,cjs.Ease.get(1)).to({scaleX:1,scaleY:1},4).wait(1));

	// 结算字1
	this.instance_1 = new lib.结算字1_1();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-9.2,264.4);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(19).to({_off:false},0).to({alpha:1},6,cjs.Ease.get(1)).wait(6));

	// 结算怪兽
	this.instance_2 = new lib.结算怪兽();
	this.instance_2.parent = this;
	this.instance_2.setTransform(14.9,-141.2);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(6).to({_off:false},0).to({x:-57.1,alpha:1},6,cjs.Ease.get(1)).to({x:-44.3},4).wait(15));

	// 结算小男孩
	this.instance_3 = new lib.结算小男孩_1();
	this.instance_3.parent = this;
	this.instance_3.setTransform(82.8,-135.6);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(6).to({_off:false},0).to({x:10.8,alpha:1},6,cjs.Ease.get(1)).to({x:23.6},4).wait(15));

	// 结算房子
	this.instance_4 = new lib.结算房子_1();
	this.instance_4.parent = this;
	this.instance_4.setTransform(116.8,-115.9);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(6).to({_off:false},0).to({x:44.8,alpha:1},6,cjs.Ease.get(1)).to({x:57.6},4).wait(15));

	// 图层 16 (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_6 = new cjs.Graphics().p("A4NYOMAAAgwbMAwbAAAMAAAAwbg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(6).to({graphics:mask_graphics_6,x:5,y:95}).wait(25));

	// 结算二维码
	this.instance_5 = new lib.结算二维码_1();
	this.instance_5.parent = this;
	this.instance_5.setTransform(-8.9,-214.4);
	this.instance_5._off = true;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(15).to({_off:false},0).to({y:86.4},7,cjs.Ease.get(1)).to({y:70.4},4).wait(5));

	// 结算元
	this.instance_6 = new lib.结算元_1();
	this.instance_6.parent = this;
	this.instance_6.setTransform(78,-278);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(31));

	// 结算奖金总额
	this.instance_7 = new lib.结算奖金总额_1();
	this.instance_7.parent = this;
	this.instance_7.setTransform(-7.8,-390,0.183,0.295);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({scaleX:1.25,scaleY:1.11},6,cjs.Ease.get(1)).to({scaleX:1,scaleY:1},4).wait(21));

	// 图层 2
	this.instance_8 = new lib.结算背景_1();
	this.instance_8.parent = this;
...
p.nominalBounds = new cjs.Rectangle(-40,-117.1,93.5,124);
...
(lib.h头像框_1 = function(mode,startPosition,loop) {
	...
	// p1bt圆
	this.instance_3 = new lib.p1bt圆();
	this.instance_3.parent = this;
	this.instance_3.setTransform(-0.5,-101.7,3.342,3.342);
...
(lib.page3 = function(mode,startPosition,loop) {
	...
	this.btn2.setTransform(455.5,891.5,1,1,0,0,0,46.5,63.5);

	this.btn1 = new lib.Symbol1();
	this.btn1.parent = this;
	this.btn1.setTransform(229.5,892,1,1,0,0,0,46.5,64);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_4},{t:this.instance_3},{t:this.instance_2},{t:this.instance_1},{t:this.instance},{t:this.btn1},{t:this.btn2}]}).wait(1));
...
(lib._2游戏 = function(mode,startPosition,loop) {
	...
	this.instance = new lib._2故障2();
	this.instance.parent = this;
	this.instance.setTransform(-109.4,-241.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// ⭐️p3爆炸
	this.instance_1 = new lib.p3爆炸();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-224.8,126.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

	// 2道路1
	this.instance_2 = new lib._2道路1_1();
	this.instance_2.parent = this;
	this.instance_2.setTransform(-424.5,216.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1));

	// ⭐️2房子1
	this.instance_3 = new lib._2房子1_1();
	this.instance_3.parent = this;
	this.instance_3.setTransform(-284.7,192.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(1));

	// 2道路2
	this.instance_4 = new lib._2道路2_1();
	this.instance_4.parent = this;
	this.instance_4.setTransform(-305.1,-22.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(1));

	// ⭐️2房子2
	this.instance_5 = new lib._2房子2_1();
	this.instance_5.parent = this;
	this.instance_5.setTransform(-240.2,-257.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(1));

	// 2飞碟和梯子
	this.instance_6 = new lib._2飞碟和梯子();
	this.instance_6.parent = this;
	this.instance_6.setTransform(-164.7,-197.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(1));

	// 2道路第三段
	this.instance_7 = new lib._2道路第三段();
	this.instance_7.parent = this;
	this.instance_7.setTransform(-69,-208.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(1));

	// 2背景
	this.instance_8 = new lib._2背景_1();
	this.instance_8.parent = this;
	this.instance_8.setTransform(-260.5,-0.5);
...
}).prototype = getMCSymbolPrototype(lib.page4, new cjs.Rectangle(-6.5,0,646.5,1029), null);
