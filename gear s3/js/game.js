...
var GameJs = (function () {
    ...
    function onGameSuccess() {
        ...
        downtimeControl.stop(function (data) {
            ...
            exportRoot.gameView.successMc.timeBox.n5.gotoAndStop(a[0])
            exportRoot.gameView.successMc.timeBox.n4.gotoAndStop(a[1])
            exportRoot.gameView.successMc.timeBox.n3.gotoAndStop(a[2])
            exportRoot.gameView.successMc.timeBox.n2.gotoAndStop(a[3])
            exportRoot.gameView.successMc.timeBox.n1.gotoAndStop(a[4])
            exportRoot.gameView.successMc.timeBox.n0.gotoAndStop(a[6])
            endPage();
        })
    }
